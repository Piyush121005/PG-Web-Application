<?php
  ...
  if (isset($_POST['delete_profile'])) {
    // Delete related rows from interested_users_properties first
    $delete_interested_properties_query = "DELETE FROM interested_users_properties WHERE user_id='$user_id'";
    $delete_user_query = "DELETE FROM users WHERE id='$user_id'";

    // Execute the queries
    if (mysqli_query($con, $delete_interested_properties_query) && mysqli_query($con, $delete_user_query)) {
    ...
    <div class="row justify-content-sm-end">
      <div class="col-3 offset-9">
        <form method="post" onsubmit="return confirm('Are you sure you want to delete your profile? This action cannot be undone.');">
          <button type="submit" name="delete_profile" class="delete-profile-link btn btn-link" id="del-link">Delete Profile</button>
        </form>
      </div>
    </div>
  </div>
  ...
  <div class="page-container">
    ...
    <div class="property-heading ">
                ...
                <div class="content-container col-md-8">
                        ...
                        <div class="interested-container <?php echo "property-id-" . $pg_id; ?>">
                          ...
                          <?php
                            ...
                            <div class="interested-text">
                              <?php echo $num_interested; ?> interested
                            </div>
                        </div>
                    ...
                    <div class="detail-container">
                        ...
                        <div class="property-gender">
                          <?php if( $gender_allowed == "male" ) { ?>
                            <img src="img/male.png" />
                          <?php } elseif( $gender_allowed == "female" ) { ?>
                    ...
                    <div class="price-container">
                        <div class="property-price">₹ <?php echo number_format($pg_rent); ?>/-</div>
                        <div class="property-occupancy">Per Month</div>
                    </div>
                </div>
            </div>
      ...
      <?php
        ...
        else   //When the user hasn't liked any property yet...
        {
      ?>
          <div class="no-interest-property text-center">
            <img src="./img/sad-emoji.png" alt="Sad Emoji" class="img-fluid sad-img">
            <h4 class="mt-5">You haven't liked any property yet!</h4>
          </div>
      <?php
        }
      ?>
      <!-- End of property list container -->
  </div>
